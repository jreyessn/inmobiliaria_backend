...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "since"                   => "Fecha Desde",
        "until"                   => "Fecha Hasta",
        "limit_credit"            => "Límite de Crédito",
        "country_id"              => "País",
        "bathrooms"               => "Habitaciones",
        "bedrooms"                => "Baños",
        "covered_garages"         => "Garajes Cubiertos",
        "uncovered_garages"       => "Garajes Descubiertos",
        "measure_unit_id"         => "Unidad de Medida",
        "unit_price"              => "Precio Unitario",
        "sale_price"              => "Precio de Venta",
        "type_furniture_id"       => "Tipo de Inmueble",
        "city_id"                 => "Ciudad",
        "postal_code"             => "Código Postal",
        "address"                 => "Dirección",
        "street_number"           => "Número de Calle",
        "aditional_info_address"  => "Información Adicional de Dirección",
        "flat"                    => "Pisos",
        "reference_address"       => "Dirección de Referencia",
        "getter_user_id"          => "Captador",
        "agent_user_id"           => "Corredor Responsable",
        "serie"                      => "Serie",
        "number"                     => "Numero",
        "furniture_id"               => "Inmueble",
