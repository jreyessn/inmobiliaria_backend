...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "categories_equipment_id" => "Categoría del Equipo",
        "no_serie"                => "No. Serie",
        "area_id"                 => "Area",
        "between_days_service"    => "Días entre Servicios",
        "cost"                    => "Costo",
        "maintenance_required"    => "Require mantenimiento",
        "no_serie_visible"        => "No. Serie Visible",
        "parts"                   => "Partes del Equipo",
        "categories_service_id"   => "Etiqueta del Servicio",
        "type_service_id"         => "Tipo del Servicio",
        "user_assigned_id"        => "Técnico",
        "farm_id"                 => "Granja",
        "event_date"              => "Fecha",
        "equipments_part_id"      => "Parte del Equipo",
        "received_by"             => "Cliente",
        "signature"               => "Firma",
        ...
        "model"                   => "Modelo",
        "license_plate"           => "Placa",
        "expiration_license_at"   => "Vencimiento de Placa",
        "no_serie"                => "No. Serie",
        "insurance_policy"        => "Poliza de Seguro",
        "comments"                => "Comentarios",
        "expiration_policy_at"    => "Vencimiento de Poliza",
