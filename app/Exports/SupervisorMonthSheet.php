...
class SupervisorMonthSheet implements FromView, WithCharts, WithEvents
{
    
    function __construct($item)
    {
        $this->supervisorData = $item['data'];
    ...
    public function charts()
    {
        ...
        $title1 = new Title('Resultado de Supervisor por Mes de Visitas a Granjas - '.$this->titleSheet);
